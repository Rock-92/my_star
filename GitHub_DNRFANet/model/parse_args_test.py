...
def parse_args():
    ...
    # choose model
    parser.add_argument('--model', type=str, default='DNRFANet', help='CDNNet, DNANet, UNet, DNRFANet, AGPCNet, HCFNet, SeRankDet')
    ...
    parser.add_argument('--scale_method', type=str, default='deconv', help='deconv, biinterp')
    ...
    parser.add_argument('--st_model', type=str, default='D:/DNRFA-Net/result/fits_softCircle_modified_DNRFANet_20250223', help='model store directory')
    parser.add_argument('--model_dir', type=str, default ='D:/DNRFA-Net/result/fits_softCircle_modified_DNRFANet_20250223/recall_0.9305073683487342_precision_0.9120231642032255_CDNNet_fits_softCircle_modified_epoch24.pth.tar', help='model path')
    ...
    if args.preprocess.lower() in ['minmax','meanstd','sigmacut'] and args.in_channels!=1:
        args.in_channels = 1
        print('in_channels changed to 1')
    return args