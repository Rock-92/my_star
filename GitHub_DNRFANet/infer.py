        ...
        with torch.no_grad():
            ...
            for _, (data, data_name) in enumerate(tbar):
                ...
                for num in range(len(pred)):
                    ...
                    predsss = np.array((torch.sigmoid(pred[num]) > 0.01).cpu()).astype('int64') * 255
            ...
            test_img = fits.getdata('D:/DNRFA-Net/dataset/fitstrans/fitsdata/4/20200821152001999_7824_824122_LVT04.fits')
            ...
            fname = os.path.join('dataset', self.args.dataset, 'ipd', '20200821152001999_7824_824122_LVT04.IPD')
