...
def gaussian_heatmap(
    ...
    for (cy, cx), radius in zip(centroids_yx, radii):
        ...
        center_y = float(cy) + shift_y
        center_x = float(cx) + shift_x
...
def build_dataset(args: argparse.Namespace) -> dict[str, Any]:
    ...
    summary = {
        ...
        "label_alignment": "stack tetra3 centroids shifted into each single-frame coordinate system from FITS RA/DEC and stack WCS",
        "heatmap": {
