...
- 传统方法：
  ...
  - `daofind4p5=daofind:4.5`
  - `daofind4p0=daofind:4.0`
  - `log3p2=log:3.2`
  - `alog3p2=alog:3.2`
...
python -u single_star_test/result_analysis/evaluate_single_frame_methods.py \
  ...
  --methods daofind5=daofind:5.0,daofind4p5=daofind:4.5,daofind4p0=daofind:4.0,log3p2=log:3.2,alog3p2=alog:3.2 \
...
python -u single_star_test/result_analysis/evaluate_single_frame_methods.py \
  ...
  --split-reason coord_holdout \
  --count 2 \
  --methods daofind5=daofind:5.0,daofind4p5=daofind:4.5,daofind4p0=daofind:4.0 \
