...
if __name__ == '__main__':
    method_res = 'serankdet'
    res_dir = os.path.join('D:/DNRFA-Net/result/visial/', method_res)
    ...
    img_fits = fits.getdata('D:/DNRFA-Net/dataset/fitstrans/fitsdata/4/20200821152001999_7824_824122_LVT04.fits')
...
#
    ...
    df_pred = pd.read_table(('D:/DNRFA-Net/outfiles/testIPD/SeRankDet_epoch98.IPD'),
                            sep='\s+', header=None, encoding='utf-8',
                            names=['col', 'row', 'pixnum', 'length', 'width', 'graysum', 'bgavg', 'bgvar'])
    df_gt = pd.read_table(('D:/DNRFA-Net/dataset/fits_softCircle_modified/ipd/20200821152001999_7824_824122_LVT04.IPD'),
                          sep='\s+', header=None, encoding='utf-8',
                          names=['col', 'row', 'pixnum', 'length', 'width', 'graysum', 'bgavg', 'bgvar'])
